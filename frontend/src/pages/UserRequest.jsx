        ...
        <div className="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700">
          <div className="px-6 py-4">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Plan Your Custom Trip</h1>
                <p className="text-gray-600 dark:text-gray-400">Tell us about your dream destination and we'll make it happen</p>
              </div>
            </div>
          </div>
        </div>
