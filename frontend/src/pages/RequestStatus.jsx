...
const RequestStatus = () => {
  ...
  const fetchUserRequests = async () => {
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_BACKEND_BASEURL}/user/requests`, {
        headers: {
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Track the status of your destination requests</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-500">You haven't submitted any destination requests yet.</p>
          </div>
        ) : (
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-900">{selectedRequest.landscape}</p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700">
                    Budget
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-900">{selectedRequest.duration}</p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700">
                    Rating
                  </label>
                  <p className="mt-1 text-sm text-gray-900">{selectedRequest.rating}</p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700">
                    Status
              ...
              <div>
                ...
                <div
                  className="text-sm text-gray-900 bg-gray-50 p-3 rounded-lg max-h-40 overflow-y-auto"
